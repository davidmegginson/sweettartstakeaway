...
/* Miscellaneous theme JS functions */

function adjust_youtube () {
    var video = $('.video');
    var youtube = $('.youtube-player');
    youtube.width(video.width());
    youtube.height(video.width() * .6);
}

adjust_youtube();
$(window).resize(adjust_youtube);

window.onload=function(){
Nifty("div#main,div#banner,div.block","normal transparent");
}
;

 var _gaq = _gaq || [];
 _gaq.push(['_setAccount', 'UA-20554637-1']);
